	...
	<div id="carouselExampleIndicators" class="carousel slide row" data-bs-ride="carousel">
			...
			<div class="d-flex justify-content-between">
				<div class="carousel-2">
					<i href="#" class="fas fa-angle-left" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="prev"></i>
					<i herf="#" class="fas fa-angle-right" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next"></i>          
				</div>
			</div>
...
<div class="container" id="anchor-shop">
	...
	<h2 class="pt-lg-5 pb-3 text-center text-lightblue-lg">電商事業</h2>
	<h4 class="text-grey-lg text-center mt-2 pb-3">知識是我們共同的血液，PanGOGO知識購服務內容創作者，同時經營科學選物商店泛科市集。</h4>
</div>
<div class="row">       
...
<div id="carouselExampleIndicators3" class="carousel slide row" data-bs-ride="carousel3">
		...
		<div class="carousel-indicators" id="indicators3">
			<button type="button" data-bs-target="#carouselExampleIndicators3" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1"></button>
			<button type="button" data-bs-target="#carouselExampleIndicators3" data-bs-slide-to="1" aria-label="Slide 2"></button>
			<button type="button" data-bs-target="#carouselExampleIndicators3" data-bs-slide-to="2" aria-label="Slide 3" class="active" ></button>
		</div>
		...
		<div class="d-flex justify-content-between">
			<div class="carousel-4">
				<i href="#" class="fas fa-angle-left" type="button" data-bs-target="#carouselExampleIndicators3" data-bs-slide="prev"></i>
				<i herf="#" class="fas fa-angle-right" type="button" data-bs-target="#carouselExampleIndicators3" data-bs-slide="next"></i>          
			</div>
		</div>
...
<img src="<?echo $img_path;?>bg/event-4.svg" class="bg-img7">
    ...
    <!-- 實際案例 -->
	<div id="carouselExampleCaptions4" class="carousel slide px-5 py-lg-5 case-fit-screen" data-bs-ride="carousel4">

<div class="d-flex justify-content-between">
  <div class="carousel-5">
	  <i href="#" class="fas fa-angle-left" type="button" data-bs-target="#carouselExampleCaptions4" data-bs-slide="prev"></i>
	  <i herf="#" class="fas fa-angle-right" type="button" data-bs-target="#carouselExampleCaptions4" data-bs-slide="next"></i>          
  </div>
</div>

<div class="carousel-inner py-lg-5 px-lg-5 py-0 px-0">

  <!-- 大型活動案例 -->
	<div class="carousel-item case-box-size" data-bs-interval="5000">

	  <div class="row pt-lg-5">
		<h2 class="text-lightblue-lg text-center pt-4 pb-lg-4 pb-3">大型活動案例</h2>
	  </div>

	  <div class="row g-5 py-lg-5">
  ...
  <!-- 媒體合作案例 -->          
	<div class="carousel-item active case-box-size" data-bs-interval="5000">

	  <div class="row py-lg-5">
		<h2 class="text-lightblue-lg text-center pt-4 pb-lg-4 pb-3">媒體合作案例</h2>
	  </div>
  ...
  <div class="carousel-item case-box-size" data-bs-interval="5000">
	...
	<div class="row py-lg-5">
	  <h2 class="text-lightblue-lg text-center pt-4 pb-lg-4 pb-3">公共合作案例</h2>
	</div>

	<div class="row">
	  <div class="offset-lg-2 col-lg-4 video-size">
		<div class="card-adj">
	...
	<!-- 我們的客戶／品牌牆 -->
	  <div class="carousel-item" data-bs-interval="5000">
		...
		<div class="row py-lg-5">
		  <h2 class="text-lightblue-lg text-center pt-4 pb-lg-4 pb-3">我們的客戶</h2>
...
<div class="container pb-lg-5">
	...
	<div class="row my-4 px-5">
		<div href="" class="offset-lg-2 col-lg-2 btn-lightblue" type="button">送出</div>
	</div>
